...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Welcome to online shopping.</p>
    
        <div class="social-icons">
            
        <a href="http://facebook.com" class='active' target="_blank"><i class="icon fa fa-facebook"></i></a>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(977) 01-548659<br>(977) 01-548669</p>
                </div>
            </li>
