...
include('backend/updateProduct.php');
...
if(isset($_POST['submit']))
{
	...
	$productpricebd=$_POST['productpricebd'];
     updateProduct($category,$subcat,$productname,$productcompany,$productprice,$productdescription,$productscharge,$productavailability,$productpricebd,$pid);
